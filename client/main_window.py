...
class ClientMainWindow(QMainWindow):
    ...
    def history_list_update(self):
        """
        Метод - заполняющий историю переписки с текущим собеседником.
        """
    ...
    def select_active_user(self):
        """
        Метод - обработчик двойного клика по списку контактов.
        """
    ...
    def add_contact_window(self):
        """
        Метод - создающий окно добавления контакта.
        """
    ...
    def add_contact_action(self, item):
        """
        Метод - обрабатывающий нажатие кнопки "добавить".
        """
    ...
    def add_contact(self, new_contact):
        ...
        После добавления обновляет содержимое окна "Контакты"
        """
        try:
    ...
    def delete_contact(self, item):
        """
        Метод - удаляющий контакт из БД.
        После удаления обновляет содержимое окна "Контакты"
        """
    ...
    def send_message(self):
        """
        Метод - отправляющий сообщение текущему контакту.
        Шифрует, а затем отправляет сообщение"
        """
    ...
    def message(self, message):
        """
        Слот обработчик приходящих сообщений, выполняет дешифровку
        приходящих сообщений и их сохранение в истории сообщений.
    ...
    def connection_lost(self):
        """
        Слот - обрабатывающий потерю соединения с сервером.
        Выдает окно с информацией и завершает работу приложения.
        """
    ...
    def make_connection(self, trans_obj):
        """
        Метод, который обеспечивает соединение сигналов и слотов
        """
